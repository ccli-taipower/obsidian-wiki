...
### 8. 🔥 佳立鈣 1,200 mg elemental Ca/日 —— 二級可調整因子

實際劑量：**500 mg × 2 顆/餐 × 3 餐 = 6 顆/日 = 3,000 mg 碳酸鈣 = 約 1,200 mg elemental Ca/日**。

**問題定位：**

1. **KDIGO 上限警戒**：CKD-MBD 患者鈣型 binder 建議 < 1,500 mg elemental Ca/日。1,200 mg 在上限附近。
2. **磷已控制良好**（P=4.6）→ 不需要這麼強的 binder 壓制。
3. **adynamic bone 強烈懷疑**（iPTH 17.5 + ALP 61 偏低）→ 骨頭無法吸收鈣 → **多餘鈣跑到血管 / 軟組織**。
4. **腹部 MRI 證實**：主動脈 + 冠狀動脈鈣化 → 1,200 mg/日 持續加重這個進展。
