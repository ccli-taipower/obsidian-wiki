...
- [Fingering (music) — Wikipedia](src_piano_fingering_wikipedia.md) — 指法百科概述、歷史演變、Bach 的拇指革新
- [鋼琴指法教學文章合集（8 篇）](src_piano_fingering_articles.md) — 基礎原則、和弦指法、調式指法、極簡主義指法、7 條規則
- [Graham Fitch & Tim Stein 影片系列（6 部）](src_graham_fitch_video_series.md) — 音階琶音指群法、Rubinstein 方案、手部重分配、音樂性指法
- [鋼琴指法教學第二批（7 篇）](src_piano_fingering_articles_batch2.md) — 手指個性、音域適應指法、換指進階、踏板與指法
