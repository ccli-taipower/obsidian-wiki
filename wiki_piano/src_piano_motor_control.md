...
### 與 V6 的關聯
觸覺差異支持 [[concept_musical_fingering|音樂性指法]] — 不同手指的觸覺特性不同。
...
### 核心
Georgia Tech 開發的觸覺感測系統，用感測器貼在鋼琴鍵上偵測手指敲擊。與 [[src_detect_track_pianist]] 類似但使用觸覺（非視覺）方式。
...
- 呼應 Chopin 的「五指五色」和 [[concept_musical_fingering]]
